...
#'multi-ip destination port' => 'If the destination port is blank then the source port will be used as the destination port.',
#'multi-ip device' => 'Device',
#'multi-ip device note' => '<B>Note:</B> The standard interfaces appear in the list for reference only; they cannot be edited or removed.',
#'multi-ip edit' => 'Edit Alias',
#'multi-ip enable alias' => 'Enable/Disable Alias',
#'multi-ip enabled' => 'Enabled',
#'multi-ip forwarding updated' => 'multi-ip forwarding updated',
#'multi-ip iface error' => 'You cannot edit or remove a configured interface!',
#'multi-ip invalid' => 'Invalid',
#'multi-ip ip address added or updated' => 'multi-ip ip address added or updated; restarting network',
#'multi-ip ip address removed' => 'multi-ip ip address removed; restarting network',
#'multi-ip netmask' => 'Netmask',
#'multi-ip new dest' => 'New destination IP',
#'multi-ip new ip address' => 'Add a new IP address:',
#'multi-ip non-static' => 'You must have a static Red IP address to add multiple static Red IPs!',
...
#'multi-ip source port' => 'If the source port is blank then ALL ports will be forwarded.',
#'multi-ip title' => 'Multiple&nbsp;IP&nbsp;address&nbsp;configuration',
#'multiip-update current alias' => 'Update current alias:',
#'multiip-update' => 'Update Alias',
#'multi-ip updating' => 'Updating IP address',
#'multiip-validate' => 'Removing an alias will also delete any port forwarding rules associated with that alias. Are you sure you want to do this?',
...
#'new destination portc' => 'New Destination Port:',
#'new destination port' => 'New Destination Port',
#'new destination ifacec' => 'New Destination Interface:',
#'new destination iface' => 'New Destination Interface',
#'new destination ippfc' => 'New Destination IP or Network:',
...
#'original destination portc' => 'Orig Dest Port:',
...
#'source ifacec' => 'Inbound Interface:',
...
#'source ippfc' => 'Original Destination IP/Network/MAC:',
#'source port' => 'Original Destination Port:',
#'source port or rangec' => 'Original Destination Port/Range:',
#'src devc' => 'Source Dev:',
#'src dev' => 'Source Dev',
#'ssmulti-ip addresses' => 'multiple IPs',
#'ssport forwarding' => 'firewall control',
...
'smoothinfo-apache-error-help1' => 'If you specify a search string and <b>number of lines is blank</b>, <font color=\'red\'><b>all matching lines</b></font> will be returned and that can be a lot !',
'smoothinfo-apache-error-help2' => 'If you specify a search string and a number of lines, <b>only the first or last \'n\' lines of the results</b> will be displayed.',
...
'smoothinfo-confirm' => 'Please be careful not to provide unneeded information. Click OK to generate the report or Cancel to review your choices.',
...
'smoothinfo-core-services' => 'Core services status',
'smoothinfo-cpu' => 'CPU information',
'smoothinfo-default-secpol' => 'Firewall security policy',
'smoothinfo-define-number-of-lines' => 'Please specify a <u>limited</u> number of lines in the Apache error log or the system log to append to the report. This is to preserve readability in support posts.',
'smoothinfo-define-secpol' => 'Please define your firewall default security policy.',
'smoothinfo-dhcpinfo' => 'DHCP Information',
...
'smoothinfo-diskspace' => 'Disk space',
'smoothinfo-dmesg' => 'Dmesg:',
'smoothinfo-dmesg-help' => 'If <b>number of lines and search string are blank</b> the whole of the dmesg log will be displayed.',
'smoothinfo-dmesg-tip' => 'Bootup messages (/var/log/dmesg)',
'smoothinfo-dmesg2' => 'Dmesg',
'smoothinfo-dns' => 'DNS info',
'smoothinfo-edit' => 'Editable report:',
'smoothinfo-edit-tip' => 'The report will be editable right from the input box below.',
'smoothinfo-ethernet-reported' => 'Ethernet adapters as reported by lspci',
'smoothinfo-external-access' => 'External access',
'smoothinfo-firewall policy' => 'Firewall default security policy',
'smoothinfo-firewall' => 'Firewall rules',
'smoothinfo-firewall-config-type' => 'Firewall config type',
...
'smoothinfo-ifconfig' => 'Network interfaces',
...
'smoothinfo-internal-pinholes' => 'Internal pinholes',
'smoothinfo-irq' => 'Interrupt request assignments',
'smoothinfo-irqs' => 'Interrupt request assignments',
...
'smoothinfo-livesettings' => 'Network settings, live values',
'smoothinfo-log-help' => 'Help',
'smoothinfo-memory' => 'Memory',
'smoothinfo-memory-specs' => 'Memory specs',
'smoothinfo-memory-tip' => 'Current state of memory usage (physical and swap).',
'smoothinfo-mod-services-status' => 'Mod services status',
...
'smoothinfo-mods2' => 'other detected mod',
'smoothinfo-modules' => 'Loaded modules',
'smoothinfo-modules-tip' => 'Lists all loaded modules.',
'smoothinfo-net settings' => 'Network settings',
'smoothinfo-net settings-tip' => 'Current network setttings, configured and live',
'smoothinfo-netsettings1' => 'Network interfaces',
'smoothinfo-netsettings2' => 'Network settings, configured',
...
'smoothinfo-other-informationc' => 'Other information:',
...
'smoothinfo-outgoing-exceptions' => 'Outgoing exceptions',
'smoothinfo-policy' => 'Policy',
'smoothinfo-portfw' => 'Port forwarding rules',
...
'smoothinfo-routes' => 'Routing information',
...
'smoothinfo-services-status' => 'Stock services status',
...
'smoothinfo-smoothwall-version' => 'Smoothwall version',
...
'smoothinfo-top' => 'Resource usage snapshot',
'smoothinfo-top-tip' => 'Output of \'/usr/bin/top -b -n 1\'.',
'smoothinfo-traffic-originating' => 'Traffic originating on',
'smoothinfo-warn' => ' >>> &nbsp THIS MUST BE DONE ON A <BLINK><B>CLIENT WORKSTATION</B></BLINK>, NOT ON SMOOTHWALL. &nbsp <<< ',
'smoothinfo-wrap-prefix' => 'Wrap lines after &nbsp',
'smoothinfo-wrap-suffix' => '&nbsp characters',
